...
namespace Geico.RoadSideAssistanceService.Contracts
{
    public interface IRoadsideAssistanceService
    {
        ...
        */
        ...
        /**
       * This method reserves selected assistant for a Geico customer that is stranded on the roadside due to a disabled vehicle.
       *
       * @param customer - Represents a Geico customer
       * @param assistantId - Selected Assistant Id
       * @return The Assistant that is on their way to help
       */
        Optional<Assistant> ReserveAssistant(Customer customer, Guid assistantId);
        ...
        */
        ...
        /**
       * This method adds a new Assistant.
       *
       * @param assistant - A new assistant
       */
